...
use App\Http\Resources\Api\Transaction\RequestRefundResource;
...
class RequestRefundRequest extends ApiRequest
{
    ...
    public function run(): JsonResponse
    {
        ...
        $RequestRefund->setStatus(Constant::REQUEST_REFUND_STATUSES['Pending']);
        $RequestRefund->save();
...
//            $Transaction->refresh();
         ...
         //   $RequestRefund->save();
            return $this->successJsonResponse([__('messages.saved_successfully')],new RequestRefundResource($RequestRefund),'RequestRefund');
       // }else{
